...
import de.tomssoftware.aeroglide.core.common.toLocalDurationString
...
import de.tomssoftware.aeroglide.core.item.DataField
import de.tomssoftware.aeroglide.core.model.database.Activity
import timber.log.Timber
import de.tomssoftware.aeroglide.core.ui.R as uiR
    ...
    Column(modifier = Modifier.padding(8.dp)) {
        ...
        Row {
            DataField(
                ...
                drawableRes = de.tomssoftware.aeroglide.core.ui.R.drawable.stairs_24px,
                modifier = Modifier.weight(1f)
            )
            DataField(
