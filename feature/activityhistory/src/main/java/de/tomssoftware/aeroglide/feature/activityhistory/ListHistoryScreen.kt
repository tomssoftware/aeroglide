...
import de.tomssoftware.aeroglide.core.common.toLocalDateString
import de.tomssoftware.aeroglide.core.common.toLocalTimeString
import de.tomssoftware.aeroglide.core.common.units.LocalUnit
import de.tomssoftware.aeroglide.core.common.units.UnitConverter
import de.tomssoftware.aeroglide.core.model.database.Activity
import de.tomssoftware.aeroglide.navigation.navigateToDataExportScreen
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                Row(horizontalArrangement = Arrangement.SpaceBetween, modifier = Modifier.fillMaxWidth()) {
                    Text(text = stringResource(de.tomssoftware.aeroglide.core.ui.R.string.sid_date), fontSize = 16.sp)
                    Text(text = toLocalDateString(activity.begin), fontSize = 16.sp)
                }
                Row(horizontalArrangement = Arrangement.SpaceBetween, modifier = Modifier.fillMaxWidth()) {
                    Text(text = stringResource(de.tomssoftware.aeroglide.core.ui.R.string.sid_time), fontSize = 16.sp)
                    Text(text = toLocalTimeString(activity.end), fontSize = 16.sp)
                }
                Row(horizontalArrangement = Arrangement.SpaceBetween, modifier = Modifier.fillMaxWidth()) {
                    Text(text = stringResource(de.tomssoftware.aeroglide.core.ui.R.string.sid_distance), fontSize = 16.sp)
                    Text(
                        text = LocalUnit
