package de.tomssoftware.aeroglide.core
...
sealed class Screen(val route: String) {
    ...
    data object AuthenticationScreen : Screen(route = "AuthenticationScreen")
    data object RegisterScreen : Screen(route = "RegisterScreen")
