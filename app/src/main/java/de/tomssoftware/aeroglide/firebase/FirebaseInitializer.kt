package de.tomssoftware.aeroglide.firebase

import android.content.Context
import de.tomssoftware.aeroglide.BuildConfig
    ...
    fun initialize() {
        ...
        if (BuildConfig.DEBUG) {
            ...
            val options = FirebaseOptions.Builder()
                ...
                .setApplicationId("de.tomssoftware.aeroglide") // Should match your packageName
